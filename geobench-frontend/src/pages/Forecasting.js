...
export default function Forecasting() {
    return (
        <div>
            ...
            <div className="alert bg-dark border-info text-light shadow-sm" style={{ borderLeft: '4px solid #348abd' }}>
                <h5 style={{ color: '#348abd' }}>Supervised Model Pending</h5>
            ...
            <div className="row mt-4">
                <div className="col-md-8">
                    <div className="card bg-dark border-secondary shadow" style={{ height: '400px' }}>
                        ...
                        <div className="card-body d-flex justify-content-center align-items-center text-muted" style={{ backgroundColor: '#1e1812' }}>
                ...
                <div className="col-md-4">
                    <div className="card bg-dark border-secondary shadow h-100">
                        ...
                        <div className="card-body text-muted d-flex flex-column justify-content-center align-items-center" style={{ backgroundColor: '#1e1812' }}>
                            <h1 className="display-4 fw-bold" style={{ color: '#372c20' }}>--%</h1>
