"""
Django settings for geophone_project project.
...
WSGI_APPLICATION = 'geophone_project.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DJANGO_DATABASE_URL', 'sqlite:///db.sqlite3'),
        conn_max_age=600,
